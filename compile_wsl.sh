...
cp "${SRC_DIR}/robopy_controller/files_utili/respeaker_lite_firmware_led_v13.yaml" "${BUILD_DIR}/respeaker.yaml"
...
echo "🔌 Activating ESPHome virtual environment..."
...
cp .esphome/build/respeaker-lite/.pioenvs/respeaker-lite/firmware.factory.bin "${BUILD_DIR}/output/firmware_led_v13.factory.bin"

echo "📤 Copying compiled firmware to Raspberry Pi..."
scp "${BUILD_DIR}/output/firmware_led_v13.factory.bin" robopy@marcus:/tmp/firmware_led_v13.factory.bin

echo "=================================================="
echo " 🎉 COMPILATION AND TRANSFER SUCCESSFUL!"
echo "   Binary is now on Pi: /tmp/firmware_led_v13.factory.bin"
echo "=================================================="
