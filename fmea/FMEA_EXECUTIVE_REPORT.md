...
**Data Generazione:** 2026-07-30 21:49:26  
...
| :--- | :---: | :--- |
| **Totale Modalità di Guasto (FM)** | **43** | Copertura integrata dei sottosistemi Marcus |
| **🟢 Risk Level LOW** | **22** | $RPN_{res} \le 50$ (Sotto controllo) |
| **🟡 Risk Level MEDIUM** | **6** | $51 \le RPN_{res} \le 199$ (Monitoraggio attivo) |
| **🟠 Risk Level HIGH** | **4** | $200 \le RPN_{res} \le 349$ (Mitigazione obbligatoria) |
| **🔴 Risk Level CRITICAL** | **0** | $RPN_{res} \ge 350$ (Blocco rilasci) |
| **🚨 REVISION_MANDATORY** | **11** | **Override Severità ($S \ge 9$)** - Massima Priorità Ingegneristica |

### Ripartizione per Sottosistema:
- **System/DDS:** 3 failure modes
- **Nav2:** 8 failure modes
- **VUI Audio:** 6 failure modes
...
| :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :--- |
| **FM-NAV-009** | Nav2/Vision | `semantic_costmap_injector / oak_d_lite` | Caduta dalle scale o da dislivelli (Negative Obstacle Fall) | 10 ➔ 10 | 560 ➔ **560** | `REVISION_MANDATORY` | `OPEN` | N/A |
| **FM-VIS-003** | Vision/Hardware | `oak_d_mount / tf_broadcaster` | Falso rilevamento ostacoli (Muri Inesistenti) o mancata rilevazione pavimento causati da Drift Meccanico (Sag) della telecamera | 8 ➔ 8 | 336 ➔ **336** | `HIGH` | `OPEN` | N/A |
...
| **FM-NAV-008** | Nav2 | `local_planner_mppi` | Urti sistematici o micro-oscillazioni della traiettoria per incompatibilità parametrica di lungo termine | 5 ➔ 5 | 315 ➔ **315** | `HIGH` | `OPEN` | N/A |
...
| :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| **FM-NAV-009** | Nav2/Vision | `semantic_costmap_injector / oak_d_lite` | Caduta dalle scale o da dislivelli (Negative Obstacle Fall) | 10 | 7 | 8 | **560** | `REVISION_MANDATORY` | `OPEN` | [`docs/lessons/nav2_slam_tuning.md`](docs/lessons/nav2_slam_tuning.md) |
| **FM-VIS-003** | Vision/Hardware | `oak_d_mount / tf_broadcaster` | Falso rilevamento ostacoli (Muri Inesistenti) o mancata rilevazione pavimento causati da Drift Meccanico (Sag) della telecamera | 8 | 6 | 7 | **336** | `HIGH` | `OPEN` | [`docs/lessons/telemetry_and_autotuning.md`](docs/lessons/telemetry_and_autotuning.md) |
...
| **FM-NAV-008** | Nav2 | `local_planner_mppi` | Urti sistematici o micro-oscillazioni della traiettoria per incompatibilità parametrica di lungo termine | 5 | 9 | 7 | **315** | `HIGH` | `OPEN` | [`docs/lessons/telemetry_and_autotuning.md`](docs/lessons/telemetry_and_autotuning.md) |
